  ...
  return (
    <div className="w-1/5 text-center ">
      <div className="border-b pb-4 flex flex-col ">
        <h1 className="mb-2 text-red-600 font-semibold">Region</h1>
      ...
      <div className="border-b pb-4 mt-3 flex flex-col">
        <h1 className="mb-2 text-red-600 font-semibold">Cuisine</h1>
      ...
      <div className="mt-3 pb-4">
        <h1 className="mb-2 text-red-600 font-semibold">Price</h1>
        <div className="flex">
